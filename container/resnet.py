...
def resnet_main(flags, model_function, input_function):
    ...
    for _ in range(flags.train_epochs // flags.epochs_per_eval):
        ...
        def input_fn_train():
            return input_function(True, flags.training_dir, flags.training_channel, flags.batch_size,
                                  flags.epochs_per_eval, flags.num_parallel_calls,
                                  flags.multi_gpu, flags.mode)
        ...
        def input_fn_eval():
            return input_function(False, flags.evaluation_dir, flags.evaluation_channel, flags.batch_size,
                                  1, flags.num_parallel_calls, flags.multi_gpu, flags.mode)
