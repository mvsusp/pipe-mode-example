...
def input_fn(is_training, data_dir, channel_name, batch_size, num_epochs=1, num_parallel_calls=1, multi_gpu=False,
             mode='File'):
...
if __name__ == '__main__':
    ...
    try:
        ...
        hyperparameters = HParams(model_dir=env.model_dir, data_format=None, training_channel='training',
                                  evaluation_channel='validation', training_dir=env.channel_dirs['training'],
                                  evaluation_dir=env.channel_dirs['validation'], **env.hyperparameters)
